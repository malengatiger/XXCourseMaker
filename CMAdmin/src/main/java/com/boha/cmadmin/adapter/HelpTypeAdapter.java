...
public class HelpTypeAdapter extends ArrayAdapter<HelpTypeDTO> {

	private final LayoutInflater mInflater;
	private final int mLayoutRes;
	private List<HelpTypeDTO> mList;
	private Context ctx;

	public HelpTypeAdapter(Context context, int textViewResourceId,
			List<HelpTypeDTO> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		HelpTypeDTO r = mList.get(position);
		viewHolderItem.txtName.setText(r.getHelpTypeName());
		viewHolderItem.txtNumber.setVisibility(View.GONE);
		viewHolderItem.image.setImageDrawable(ctx.getResources().getDrawable(R.drawable.help_32));
