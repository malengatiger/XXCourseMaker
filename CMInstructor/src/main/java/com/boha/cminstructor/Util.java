...
import com.boha.coursemaker.dto.RecurrenceDTO;
...
public class Util {
	...
	public static RecurrenceDTO getRecur(int index, Date date) {
		...
		case 0:
			return null;
		case 1:
			dto.setFrequency(RecurrenceDTO.FREQ_DAILY);
			break;

		case 2:
			dto.setFrequency(RecurrenceDTO.FREQ_WEEKLY);
			ArrayList<String> days = new ArrayList<String>();
			days.add(RecurrenceDTO.MONDAY);
			days.add(RecurrenceDTO.TUESDAY);
			days.add(RecurrenceDTO.WEDNESDAY);
			days.add(RecurrenceDTO.THURSDAY);
			days.add(RecurrenceDTO.FRIDAY);
			dto.setByDayList(days);
		...
		case 3:
			...
			String day = getDayOfWeekShort(dayOfWeek);
			ArrayList<String> days2 = new ArrayList<String>();
			days2.add(day);
			dto.setByDayList(days2);
			break;

		case 4:
			dto.setFrequency(RecurrenceDTO.FREQ_MONTHLY);
			int dayOfWeek2 = cal.get(Calendar.DAY_OF_WEEK);
			String day2 = getDayOfWeekShort(dayOfWeek2);
			ArrayList<String> days3 = new ArrayList<String>();
			days3.add(day2);
			dto.setByDayList(days3);

			break;
		case 5:
			dto.setFrequency(RecurrenceDTO.FREQ_MONTHLY);
			int dayOfMonth = cal.get(Calendar.DAY_OF_MONTH);
			dto.setByMonthDay(dayOfMonth);
			break;
		case 6:
			dto.setFrequency(RecurrenceDTO.FREQ_YEARLY);
			int dayOfMonth2 = cal.get(Calendar.DAY_OF_MONTH);
			int mth = cal.get(Calendar.MONTH);
			dto.setByMonthDay(dayOfMonth2);
			dto.setMonth(mth);
			break;
		}
	...
	public static String getDayOfWeekShort(int i) {
		switch (i) {
		case 2:
			return RecurrenceDTO.MONDAY;
		case 3:
			return RecurrenceDTO.TUESDAY;
		case 4:
			return RecurrenceDTO.WEDNESDAY;
		case 5:
			return RecurrenceDTO.THURSDAY;
		case 6:
			return RecurrenceDTO.FRIDAY;
		case 7:
			return RecurrenceDTO.SATURDAY;
		case 1:
			return RecurrenceDTO.SUNDAY;
	...
	public static int[] getTime(Date date) {
		SimpleDateFormat df = new SimpleDateFormat("HH", locale);
		String hr = df.format(date);
		df = new SimpleDateFormat("mm", locale);
	...
	public static String getLongDate(int day, int month, int year) {
		...
		cal.set(GregorianCalendar.DAY_OF_MONTH, day);
		Date d = cal.getTime();
		SimpleDateFormat df = new SimpleDateFormat("EEEE, dd MMM yyyy", locale);
		return df.format(d);
	}
	...
	public static String getLongDateTime(Date date) {
		SimpleDateFormat df = new SimpleDateFormat(
				"EEEE, dd MMMM yyyy HH:mm:ss", locale);
		return df.format(date);
	}
	...
	public static String getLongDateTimeNoSeconds(Date date) {
		SimpleDateFormat df = new SimpleDateFormat("EEEE, dd MMMM yyyy HH:mm", locale);
		return df.format(date);
	}

	public static String getLongDateForPDF(long date) {
		SimpleDateFormat df = new SimpleDateFormat("EEE dd MMM yyyy", locale);
	...
	public static String getShortDateForPDF(long startDate, long endDate) {
		...
		StringBuilder sb = new StringBuilder();
		sb.append(df.format(dtStart)).append(" to ");
		sb.append(df.format(dtEnd));
		return sb.toString();
	}
