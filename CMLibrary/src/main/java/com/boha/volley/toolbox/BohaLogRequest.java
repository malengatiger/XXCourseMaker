...
public class BohaLogRequest extends Request<StatsResponseDTO> {

    private Listener<StatsResponseDTO> listener;
    private ErrorListener errorListener;
    private long start, end;

    public BohaLogRequest(int method, String url, ErrorListener listener) {
        super(method, url, listener);
    }

    public BohaLogRequest(int method, String url,
